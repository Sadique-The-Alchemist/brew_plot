defmodule BrewPlot.Vmodel do
  defstruct [plot_dataset: false, list: false, form: false, plot_id: false, action: false, plot: false, plots: false, share: false, shared_plot_form: false]
  @type t() :: %__MODULE__{plot_dataset: String.t()| boolean(), list: boolean(), form: any(), plot_id: integer()| boolean(), action: String.t()| boolean(), plot: any(), plots: list() | boolean(), share: boolean(), shared_plot_form: any()}
